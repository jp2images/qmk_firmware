...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_ansi_109(
        ...
        _______,            _______,  _______,  _______,  _______,  _______,  NK_TOGG,  _______,  _______,  _______,  _______,              _______,              _______,            GITPULL,  GITORG,   _______,
    ...
    switch (keycode) {
        ...
        case GITPULL:
            if (record->event.pressed) {
                ...
                //register_code(KC_ENT);
                // enter other key codes between these two fucntions.
                //unregister_code(KC_ENT);
            }
            break;
